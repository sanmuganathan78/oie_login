...
<div class="widget-content">
        <form  method="post" action="<?php echo base_url();?>customer/anniversary_search">
                    <table>
                        <tr>
                            <td> &nbsp;&nbsp;From Date &nbsp;&nbsp;
                            </td>
...
<?php  }?> 
    ...
    <?php if($_POST) {?>
<form name="form" method="post" action="<?php echo base_url();?>customer/anniversary_pdf" target="_blank" onsubmit="setTimeout(function () { location.href = '<?php echo base_url();?>customer/view_anniversaryday'; })">
