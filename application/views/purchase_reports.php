	...
	<div class="col-md-12">
		<div class="widget box">
			<div class="widget-header">
				<h4><i class="icon-reorder"></i>Purchase Reports</h4>
			...
			<form  method="post" action="<?php echo base_url();?>purchase/search">
					<table>
						<tr>
							<td> &nbsp;&nbsp;From Date &nbsp;&nbsp;
							</td>
...
<?php if($_POST) {?>
<form name="form" method="post" action="<?php echo base_url();?>purchase/pdf" target="_blank" onsubmit="setTimeout(function () { location.href = '<?php echo base_url();?>purchase/view'; })">
