  ...
  <div class="col-md-12">
    <div class="widget box">
      <div class="widget-header">
        <h4><i class="icon-reorder"></i>Manual Invoice</h4>
      </div>
      <form class="form-horizontal" method="post" target="_blank" id="form" onsubmit="setTimeout(function () { location.href = '<?php echo base_url();?>manual_invoice'; })"  action="<?php echo base_url();?>manual_invoice/insert">
        <br>
        <br>
        ...
        <div class="form-group">
          ...
          <!-- <div id="tax" style="display:none;"> -->
            ...
            <div class="col-md-2">
              <input type="text" name="invoiceno" class="form-control" id="invoiceno" value="<?php echo $cusid;?>" readonly></div>
               <label class="col-md-2 control-label" style="width:100px;">Date</label>
              <div class="col-md-2">
             ...
             <label class="col-md-2 control-label">Customer Name:</label>
              ...
              <table class="responsive table" width="100%">
                ...
                <tbody>
                  ...
                  <td>
                  <input name="itemname[]" class="form-control itemname"  id="itemname" style="width:185px;">
                                  
                      <div id="itemname_valid"></div>
                    </td>
                    <td> <input name="price[]" class="form-control change"  id="price" style="width:100px;">
                    </td>
              ...
              <div class="col-sm-offset-5">
                ...
                <button type="submit" class="btn btn-success print" name="print" value="print" id="print">Print Bill</button>
...
<script type="text/javascript" src="<?php echo base_url();?>assets/js/plugins.form-components.js"></script>
 <script src="<?php echo base_url();?>datepicker/bootstrap-datepicker.js"></script>
        <script src="<?php echo base_url();?>datepicker/bootstrap-datepicker.min.js"></script>
    ...
    <script type="text/javascript">
      $(document).ready(function()
      {
        $('#save').click(function(){
          ...
          {
            $('#customername').focus();
            $('#cus_valid').html('<div><font color="red">Enter the Name</font></div>');
...
$('#category').blur(function(){
  ...
  $.post('<?php echo base_url(); ?>stock/category',{ category:category },function(res){
