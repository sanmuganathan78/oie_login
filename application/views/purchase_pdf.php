...
<div align="center">
  <table width="600" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
    ...
    border-top: 1px dotted #000;">
      <td class="heading1" width="316"><div align="center"><strong>Purchase Reports</strong></div></td>
...
<?php   $count=1; foreach($psd as $p) {
    ...
    echo'<tr>
      ...
      <td class="padding" valign="top">'.$purchaseno.'</td>
